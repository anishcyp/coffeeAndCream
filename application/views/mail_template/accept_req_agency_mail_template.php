                        ...
                        <tr>
                            <td align="center" valign="top" style="background:#fff;">
                                <table width="300" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="center" valign="top"><a href="#"><img editable="true" mc:edit="bm9-01" src="https://localhost/project/coffe-and-cream/public/front/images/logo/waterMark.png" style="display:block" width="100" height="auto"/></a></td>
                                    </tr>
                        ...
                        <tr>
                            <td height="330" align="center" valign="top" style="background:#fff; -moz-border-radius: 4px 4px 0px 0px; border-radius: 4px 4px 0px 0px;">
                                <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000; font-weight:normal; line-height:36px;" mc:edit="bm15-03"><multiline>Hello! <?= $agency_name ?></multiline></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:15px; color:#000; font-weight:normal; line-height:24px; padding:0px 25px;" mc:edit="bm9-06"><multiline>
                                            your job application is approve from  <?= $agency ?> Email is <span style="font-weight: bold;color:#000;"><?= $email ?></span> contact number<span style="font-weight: bold;color:#000;"> <?= $phone ?></span>
                                        </multiline>
                                        </td>
                                    </tr>
                                    <tr>
