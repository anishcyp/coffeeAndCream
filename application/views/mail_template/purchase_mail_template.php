                        ...
                        <tr>
                            <td height="330" align="center" valign="top" style="background:#fff; -moz-border-radius: 4px 4px 0px 0px; border-radius: 4px 4px 0px 0px;">
                                <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000; font-weight:normal; line-height:36px;" mc:edit="bm15-03"><multiline>Congratulations! You have successfully purchased a <?= $plan_name ?> membership plan.</multiline></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:15px; color:#000; font-weight:normal; line-height:24px; padding:0px 25px;" mc:edit="bm9-06"><multiline>
                                            The membership plan is valid for <?= $plan_times ?>.
                                            <br>
                                            The membership plan will expire on 
                                            <br>
                                            If you wish to upgrade your membership plan, contact the admin.
                                        </multiline>
                                        </td>
                                    </tr>
                                    <tr>
