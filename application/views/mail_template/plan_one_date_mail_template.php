                                ...
                                <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:15px; color:#000; font-weight:normal; line-height:24px; padding:0px 25px;" mc:edit="bm9-06"><multiline>
                                            Here is the notification email regarding your <?= $plan_name ?> that only 1 day left to expire your membership plan and you have selected and you are our subscription members so after completing your plan it will automatically it will activate again, So if you don't want to continue then please Deactivate your membership plan from your profile.
                                        </multiline>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000; font-weight:normal; line-height:36px;" mc:edit="bm15-03"><multiline>If you want to deactivate your account then Click Here </multiline></td>
                                    </tr>
                                    <tr>
                                        <td height="10" align="center" valign="top" style="font-size:10px; line-height:10px;">&nbsp;</td>
                                    </tr>
