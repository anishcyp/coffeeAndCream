            ...
            <tr>
                <td align="center" valign="top">
                    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                        ...
                        <tr>
                            <td align="center" valign="top" style="background:#fff;">
                                <table width="300" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="center" valign="top"><a href="#"><img editable="true" mc:edit="bm9-01" src="<?= base_url('public/front/images/logo/waterMark.png') ?>" style="display:block" width="100" height="auto"/></a></td>
                                    </tr>
                        ...
                        <!-- Header End -->
                        <tr>
                            <td height="210" align="center" valign="top" style="background:#fff; -moz-border-radius: 4px 4px 0px 0px; border-radius: 4px 4px 0px 0px;">
                                <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000; font-weight:normal; line-height:36px;" mc:edit="bm15-03"><multiline>Hello! Admin,</multiline></td>
                                    </tr>
                                    <tr>
                                        <td height="10" align="left" valign="top" style="font-size:50px; line-height:10px;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000; font-weight:normal; line-height:36px;" mc:edit="bm15-03"><multiline>New enquiry</multiline></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:15px; color:#000; font-weight:normal; line-height:24px; padding:0px 25px;" mc:edit="bm9-06"><multiline>
                                            User Email is <span style="font-weight: bold;color:#000;"><?=isset($email) ? $email : '';?></span>
                                            <br>
                                            User name <span style="font-weight: bold;color:#000;"><?=isset($user_fname) ? $user_fname : '';?></span>
                                        </multiline>
                                        </td>
                                    </tr>
                                </table>
