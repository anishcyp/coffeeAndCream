                        ...
                        <tr>
                            <td height="330" align="center" valign="top" style="background:#fff; -moz-border-radius: 4px 4px 0px 0px; border-radius: 4px 4px 0px 0px;">
                                <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000; font-weight:normal; line-height:36px;" mc:edit="bm15-03"><multiline>Reset Password</multiline></td>
                                    </tr>
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:48px; color:#000; font-weight:normal;" mc:edit="bm15-04"><multiline><!--Jack macke--></multiline></td>
                                    </tr>
                                    <tr>
                                        <td height="10" align="center" valign="top" style="font-size:10px; line-height:10px;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:15px; color:#000; font-weight:normal; line-height:24px; padding:0px 35px;" mc:edit="bm15-05"><multiline>Click below link to reset your password !</multiline></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" valign="top">
                                            <table width="205" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td height="50" align="center" valign="middle" bgcolor="#fff" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#3cc3c1; font-weight:bold; -moz-border-radius: 30px; border-radius: 30px;" mc:edit="bm15-06"><multiline><a href="<?=isset($url) ? $url : '';?>" style="text-decoration:none; color:#3cc3c1;line-height: 50px;display: block;border-radius: 30px;">Click Here</a></multiline></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
