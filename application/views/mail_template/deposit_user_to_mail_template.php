                        ...
                        <tr>
                            <td height="330" align="center" valign="top" style="background:#fff; -moz-border-radius: 4px 4px 0px 0px; border-radius: 4px 4px 0px 0px;">
                                <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000; font-weight:normal; line-height:36px;" mc:edit="bm15-03"><multiline>Hello! <?=isset($fname_to) ? $fname_to.' '.$lname_to : '';?></multiline></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:13px; color:#000; font-weight:normal; line-height:24px; padding:0px 25px;" mc:edit="bm9-06">
                                            <multiline>
                                                <li>A deposit of<span style="font-weight: bold;color:#000;"> <?= CURR_SYMBOL.$amount ?> </span> has been received from <span style="font-weight: bold;color:#000;"> <?= $fname.' '.$fname ?> </span>.</li>
                                                <li>Please note that the deposit will be held securely by coffeencream and will be released to you 10 working days after the job has been completed.</li>
                                                <li>A 10% process handling fee by the bank will be charged on the deposit.</li>
                                                <li>Should a client cancel a service, their initial deposit will be deposited to you regardless but will still be viable for a 10% deduction fee by the admin.</li>
                                                <li>Giving personal bank details to clients will lead to the culprits being banned from using our services for a lifetime.</li>
                                                <br><br>
                                                <b>For more on our payment guidelines click here <a style="text-decoration: none;color: #fa0000;" href="#">payment guidelines</a></b><br>
