                        ...
                        <tr>
                            <td height="330" align="center" valign="top" style="background:#fff; -moz-border-radius: 4px 4px 0px 0px; border-radius: 4px 4px 0px 0px;">
                                <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="left" valign="top">
                                            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="full">
                                                <tr>
                                                    <td align="center" valign="top"><a href="#"><img editable="true" mc:edit="bm9-01" src="<?=$site_logo;?>" style="display:block" width="150" height="auto"/></a></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000; font-weight:normal; line-height:36px;" mc:edit="bm15-03"><multiline>Hello! <?=isset($fname) ? $fname : 'There,';?></multiline></td>
                                    </tr>
                                    <tr>
                                        <td height="10" align="left" valign="top" style="font-size:50px; line-height:10px;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000; font-weight:normal; line-height:36px;" mc:edit="bm15-03"><multiline>Thanks For Your Registration</multiline></td>
                                    </tr>
                                    <tr>
                                        <td height="30" align="left" valign="top" style="font-size:50px; line-height:30px;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:15px; color:#000; font-weight:normal; line-height:24px; padding:0px 25px;" mc:edit="bm9-06"><multiline>
                                            Your Email is <span style="font-weight: bold;color:#000;"><?=isset($email) ? $email : '';?></span>
                                        </multiline>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:15px; color:#000; font-weight:normal; line-height:24px; padding:0px 35px;" mc:edit="bm15-05"><multiline>Click below link to verify your account !</multiline></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="center" valign="top">
                                            <table width="205" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td height="50" align="center" valign="middle" bgcolor="#3cc3c1" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#3cc3c1; font-weight:bold; -moz-border-radius: 30px; border-radius: 30px;" mc:edit="bm15-06"><multiline><a href="<?=isset($url) ? $url : '';?>" style="text-decoration:none; color:#fff;line-height: 50px;display: block;border-radius: 30px;">Verify My Account</a></multiline></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td align="center" valign="top" style="background:#FFF;">
                                <table width="380" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; font-weight:normal; line-height:28px;" mc:edit="bm9-13"><multiline><?=$site_name?>, <?=$address?></multiline></td>
                                    </tr>
                                    <tr>
                                        <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; font-weight:bold; line-height:28px;" mc:edit="bm9-14"><multiline>Copyright &copy; <?=$copyright_year?> <?=$site_name?>.</multiline></td>
                                    </tr>
                                    <tr>
                                        <td height="15" align="center" valign="top" style="font-size:30px; line-height:15px;">&nbsp;</td>
                                    </tr>
