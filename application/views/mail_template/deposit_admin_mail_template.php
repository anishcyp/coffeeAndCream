                                ...
                                <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:15px; color:#000; font-weight:normal; line-height:24px; padding:0px 25px;" mc:edit="bm9-06"><multiline>
                                           A deposit of <span style="font-weight: bold;color:#000;"> <?= CURR_SYMBOL.$amount ?> </span>  has been made by <span style="font-weight: bold;color:#000;"> <?=isset($fname) ? $fname.' '.$lname : '';?> </span> for the entertainer <span style="font-weight: bold;color:#000;"> <?=isset($fname_to) ? $fname_to.' '.$lname_to : '';?></span>.<br>
                                        </multiline>
                                        </td>
                                    </tr>
                                    <tr>
