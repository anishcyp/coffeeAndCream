        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Manage Service Image</h4>
        ...
        <div class="row">
            <div class="col-sm-12">                
                ...
                <div class="card-box table-responsive">
                         <button class="btn btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#addpopUpmodal">Add Service Image</button>
                    <div class="clearfix"></div>
                    <hr>
        ...
        <div class="modal-content">
            <form role="form" id="form-addhome_page_description" name="form-addhome_page_description" method="post"   >
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add home Service Image</h4>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#datatable-scroller').DataTable({
            ...
            "ordering": true,
            "ajax": {
                "url": "<?php echo ADMIN_LINK ?>HomepageController/ajax_home_image_datatable",
                "type": "POST"
            },            
            "scroller": {
    ...
    $(document).on("click",".rowEdit",function(){
        ...
        $.ajax(
        {
            ...
            { 
                ...
                $("#uploaded_image").attr('src','<?php echo APP_URL.UPLOAD_DIR.HOME_SER_IMG ?>'+response.page_image);
                $("#old_page_image").val(response.page_image);
    ...
    $('#form-addhome_page_description').validate({ // initialize the plugin
         rules:{
          ...
          submitHandler: function (form) {
            ...
            formData.append('td', '<?php echo base64_encode('home_service_images') ?>');
            formData.append('i', '<?php echo base64_encode('id') ?>');
            $.ajax({
                url: '<?php echo ADMIN_LINK; ?>HomepageController/insertRecordImage',
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
