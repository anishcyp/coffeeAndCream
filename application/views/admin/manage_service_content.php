        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Manage Service Content </h4>
        ...
        <div class="row">
            <div class="col-sm-12">                
                ...
                <div class="card-box table-responsive">
                         <button class="btn btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#addpopUpmodal">Add Service Content</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#datatable-scroller').DataTable({
            ...
            "ordering": true,
            "ajax": {
                "url": "<?php echo ADMIN_LINK ?>HomepageController/ajax_service_content_datatable",
                "type": "POST"
            },            
            "scroller": {
    ...
    $('#form-addhome_page_description').validate({ // initialize the plugin
         rules:{
          ...
          submitHandler: function (form) {
            ...
            formData.append('td', '<?php echo base64_encode('home_service_content') ?>');
            formData.append('i', '<?php echo base64_encode('id') ?>');
            $.ajax({
                url: '<?php echo ADMIN_LINK; ?>HomepageController/insertRecordContent',
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
