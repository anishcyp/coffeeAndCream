        ...
        <div class="row">
            <div class="col-sm-12">                
                ...
                <div class="card-box table-responsive">
                         <button class="btn btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#addpopUpmodal">Add language</button>
        ...
        <div class="modal-content">
            <form role="form" id="form-addlanguage" name="form-addlanguage" method="post"   >
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Language Detail</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="field-1" class="control-label">language Name</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#datatable-scroller').DataTable({
            ...
            "ordering": true,
            "ajax": {
                "url": "<?php echo ADMIN_LINK ?>ManageLocation/ajax_language_datatable",
                "type": "POST"
            },            
            "scroller": {
    ...
    $('#page_description').validate({ 
         rules:{
          ...
          submitHandler: function (form) {
            ...
            formData.append('td', '<?php echo base64_encode('language') ?>');
            formData.append('i', '<?php echo base64_encode('language_id') ?>');
            $.ajax({
    ...
    $(document).on("click",".rowDes",function(){
        ...
        $.ajax(
        {
            ...
            success: function (response)
            { 
                $("#editidDes").val(response.language_id);
    ...
    $(document).on("click",".rowEdit",function(){
        ...
        $.ajax(
        {
            ...
            { 
                ...
                $("#type").val('edit');
                $("#editid").val(response.language_id);
