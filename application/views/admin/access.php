        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <div class="wrapper-page">
                    ...
                    <h2 class="text-uppercase text-danger">Access Deined !</h2>
                    ...
                    <a class="btn btn-success waves-effect waves-light m-t-20" href="<?php echo ADMIN_LINK;?>dashboard"> Return Dashboard</a>
                </div>
