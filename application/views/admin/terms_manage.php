        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Term's list </h4>
        ...
        <div class="row">
            <div class="col-sm-12">                
                ...
                <div class="card-box table-responsive">
                         <button class="btn btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#addpopUpmodal">Add Term</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#datatable-scroller').DataTable({
            ...
            "ordering": true,
            "ajax": {
                "url": "<?php echo ADMIN_LINK ?>ManageLocation/ajax_terms_datatable",
                "type": "POST"
            },            
            "scroller": {
    ...
    $('#form-addCountry').validate({ // initialize the plugin
         rules:{
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
                url: '<?php echo APP_URL; ?>CommonController/terms_store',
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
