        ...
        <div class="row">
            <div class="col-sm-12">                
                ...
                <div class="card-box table-responsive">
                         <button class="btn btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#addpopUpmodal">Add Country</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#datatable-scroller').DataTable({
            ...
            "ordering": true,
            "ajax": {
                "url": "<?php echo ADMIN_LINK ?>ManageLocation/ajax_country_datatable",
                "type": "POST"
            },            
            "scroller": {
    ...
    $(document).on("click",".rowEdit",function(){
        ...
        $.ajax(
        {
            ...
            { 
                ...
                $("#type").val('edit');
                $("#editid").val(response.country_id);
    ...
    $('#form-addCountry').validate({ // initialize the plugin
         rules:{
          ...
          submitHandler: function (form) {
            ...
            formData.append('td', '<?php echo base64_encode('country') ?>');
            formData.append('i', '<?php echo base64_encode('country_id') ?>');
            $.ajax({
    ...
    $(document).on("click",".rowDes",function(){
        ...
        $.ajax(
        {
            ...
            success: function (response)
            { 
                $("#editidDes").val(response.country_id);
