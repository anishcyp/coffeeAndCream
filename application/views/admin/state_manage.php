        ...
        <div class="row">
            <div class="col-sm-12">                
                ...
                <div class="card-box table-responsive">
                         <button class="btn btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#addpopUpmodal">Add State</button>
...
<div id="addpopUpmodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" id="form-addState" name="form-addState" method="post"   >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Add state Detail</h4>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#datatable-scroller').DataTable({
            ...
            "ordering": true,
            "ajax": {
                "url": "<?php echo ADMIN_LINK ?>ManageLocation/ajax_state_datatable",
                "type": "POST"
            },            
            "scroller": {
    ...
    $('#form-addState').validate({ // initialize the plugin
         rules:{
          ...
          submitHandler: function (form) {
            ...
            formData.append('td', '<?php echo base64_encode('state') ?>');
            formData.append('i', '<?php echo base64_encode('state_id') ?>');
            $.ajax({
    ...
    $(document).on("click",".rowDes",function(){
        ...
        $.ajax(
        {
            ...
            success: function (response)
            { 
                $("#editidDes").val(response.state_id);
