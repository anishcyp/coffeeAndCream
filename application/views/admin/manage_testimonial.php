        ...
        <div class="row">
            <div class="col-sm-12">                
                ...
                <div class="card-box table-responsive">
                         <button class="btn btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#addpopUpmodal">Add Testimonial Details</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#datatable-scroller').DataTable({
            ...
            "ordering": true,
            "ajax": {
                "url": "<?php echo ADMIN_LINK ?>HomepageController/ajax_home_des_datatable",
                "type": "POST"
            },            
            "scroller": {
    ...
    $(document).on("click",".rowEdit",function(){
        ...
        $.ajax(
        {
            ...
            { 
                ...
                $("#uploaded_image").attr('src','<?php echo APP_URL.UPLOAD_DIR.SLIDER_IMG ?>'+response.page_image);
    ...
    $('#form-addhome_page_description').validate({ // initialize the plugin
         rules:{
          ...
          submitHandler: function (form) {
            ...
            formData.append('td', '<?php echo base64_encode('home_page_description') ?>');
            formData.append('i', '<?php echo base64_encode('id') ?>');
            $.ajax({
                url: '<?php echo ADMIN_LINK; ?>HomepageController/insertRecordDes',
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
