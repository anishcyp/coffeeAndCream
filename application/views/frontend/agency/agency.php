            ...
            <div class="container">
                <div class="directory-listing-form">
                    ...
                    <div class="directory-listings-search" style="max-width: 750px; margin-left: auto; margin-right: auto;">
                        <form id="service_search" class="service_search" method="post" action="javascript:void(0);" autocomplete="off">
                            
                            <div class="">
                                <div class="form-group">
                                    <label><i class="fa fa-keyboard-o" aria-hidden="true"></i></label>
                                    <input type="text" id="agency_name" name="keywords" placeholder="Type in service or location you want." class="form-control">
